...
from users.views import UserRegisterView, UserLoginView, UserProfileView, user_logout_view, UserUpdateView, UserPasswordChangeView, user_generate_new_password_view, user_password_reset_view
